...
namespace ClassLibrary
{
    ...
    public class MasterPageVirtualFile : VirtualFile
    {
        ...
        private static Stream ReadResource(string embeddedFileName)
        {
            ...
            resourceFileName = resourceFileName.Replace(".master", ".Master");
            var stream = assembly.GetManifestResourceStream(MasterPageVirtualPathProvider.VirtualPathProviderResourceLocation + "." + resourceFileName);
